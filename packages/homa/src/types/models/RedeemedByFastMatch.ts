...
type RedeemedByFastMatchProps = Omit<
  RedeemedByFastMatch,
  NonNullable<FunctionPropertyNames<RedeemedByFastMatch>>
>;
...
export class RedeemedByFastMatch implements Entity {
  ...
  static async remove(id: string): Promise<void> {
    assert(
      id !== null,
      "Cannot remove RedeemedByFastMatch entity without an ID"
    );
  ...
  static async get(id: string): Promise<RedeemedByFastMatch | undefined> {
    assert(
      ...
      "Cannot get RedeemedByFastMatch entity without an ID"
    );
  ...
  static async getByAddressId(
    addressId: string
  ): Promise<RedeemedByFastMatch[] | undefined> {
    ...
    return records.map((record) =>
      RedeemedByFastMatch.create(record as RedeemedByFastMatchProps)
    );
  }
  ...
  static create(record: RedeemedByFastMatchProps): RedeemedByFastMatch {
    ...
    const entity = new RedeemedByFastMatch(record.id);
